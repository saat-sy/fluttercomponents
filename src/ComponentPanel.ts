...
export class ComponentPanel {
   ...
   */
  public static currentPanel: ComponentPanel | undefined;

  public static readonly viewType = "component";
  ...
  public static createOrShow(extensionUri: vscode.Uri) {
    ...
    if (ComponentPanel.currentPanel) {
      ComponentPanel.currentPanel._panel.reveal(column);
      ComponentPanel.currentPanel._update();
      return;
    }
    ...
    ComponentPanel.currentPanel = new ComponentPanel(panel, extensionUri);
  }

  public static kill() {
    ComponentPanel.currentPanel?.dispose();
    ComponentPanel.currentPanel = undefined;
  }
